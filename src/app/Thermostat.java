...
public class Thermostat
{
   ...
   public boolean turnHeaterOn (ProgrammedSettings pSet)
   {
      int dTemp = pSet.getSetting(period, day);
        ...
        // 0if (((curTemp < dTemp - thresholdDiff) || (override && curTemp < overTemp - thresholdDiff)) && (timeSinceLastRun > minLag))
      // 1 if (((curTemp < dTemp - thresholdDiff) || (override || curTemp < overTemp - thresholdDiff)) && (timeSinceLastRun > minLag))     
      // 2 if (((curTemp < dTemp - thresholdDiff) && (override && curTemp < overTemp - thresholdDiff)) && (timeSinceLastRun > minLag))       
      // 3 if (((curTemp < dTemp - thresholdDiff) || (override && curTemp < overTemp - thresholdDiff)) || (timeSinceLastRun > minLag))      
      // 4 if ((curTemp < dTemp - thresholdDiff) || (override && curTemp < overTemp - thresholdDiff) && (timeSinceLastRun > minLag))     
      // 5 if (( !(curTemp < dTemp - thresholdDiff) || (override && curTemp < overTemp - thresholdDiff)) && (timeSinceLastRun > minLag))      
      // 6 if (((curTemp < dTemp - thresholdDiff) || !(override && curTemp < overTemp - thresholdDiff)) && (timeSinceLastRun > minLag))
      // 7 if (((curTemp < dTemp - thresholdDiff) || (override && curTemp < overTemp - thresholdDiff)) && !(timeSinceLastRun > minLag))
      // 8 if (((curTemp < dTemp - thresholdDiff) && (override || curTemp < overTemp - thresholdDiff)) && (timeSinceLastRun > minLag))
      // 9 if (((curTemp < dTemp - thresholdDiff) || (override || curTemp < overTemp - thresholdDiff)) || (timeSinceLastRun > minLag))
      // 10 if (((curTemp < dTemp - thresholdDiff) && (override && curTemp < overTemp - thresholdDiff)) || (timeSinceLastRun > minLag))
